                ...
                <ol class="flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse !pl-0">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center space-x-1.5">
                            ...
                            <span class="inline-flex items-center text-sm font-medium text-gray-500">Live Chat Admin</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="font-sans !font-semibold">Live Chat Monitoring</h2>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="flex h-[75vh] min-h-[500px] bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="w-1/3 md:w-1/4 border-r border-gray-200 bg-gray-50 flex flex-col">
                    ...
                    <div id="client-list" class="flex-1 overflow-y-auto p-2 space-y-1" style="scrollbar-width: thin;">
                ...
                <div class="flex-1 flex flex-col relative bg-slate-50/50">
                    ...
                    <div id="chat-messages" class="flex-1 overflow-y-auto p-4 space-y-4" style="scrollbar-width: thin;">
